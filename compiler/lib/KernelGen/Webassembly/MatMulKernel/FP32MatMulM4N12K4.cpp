...
std::shared_ptr<TContext> Fp32MatMulM4N12K4::GetInnerCtx(TContext* ctx) const {
...
bool Fp32MatMulM4N12K4::IsAvailable(TContext* context) const {
...
std::string Fp32MatMulM4N12K4::GetKernelSymbol(TContext* context) const {
    std::stringstream ss;
    ss << "WebAssembly_kernel_fp32_matmul_4x12mk4_";
...
std::vector<KernelObj> Fp32MatMulM4N12K4::GetDependInternalSymbol(
...
std::string Fp32MatMulM4N12K4::GetKernelBody(TContext* context) const {
